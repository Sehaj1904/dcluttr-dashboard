...
export default function Navigation() {
  ...
  const [navItems, setNavItems] = useState<NavigationItem[]>([
    {
      id: "overview",
      label: "Overview",
      icon:  <img src={'/home.png?height=6&width=6'} className="w-6 h-6 flex items-center justify-center" />,
      isActive: true,
    },
    {
      id: "channels",
      label: "Channels",
      icon: <img src={'/performance.png?height=6&width=6'} className="w-6 h-6 flex items-center justify-center" />,
      isExpanded: true,
      subItems: [
        {
          id: "meta-ads",
    ...
    },
    {
      id: "creatives",
      label: "Creatives",
      icon: <img src={'/creative.png?height=6&width=6'} className="w-6 h-6 flex items-center justify-center" />,
    },
  ])
  ...
  return (
    <div className="w-64 bg-[#F5F5F5] h-full flex flex-col border-r border-[#E0E0E0]">
      <div className="p-4 flex items-center justify-between bg-white rounded-[10px] mx-4 mt-4 mb-6 border border-[#E0E0E0]">
        <div className="flex items-center">
        <img src={'/ss.png?height=8&width=8'} className="w-8 h-8 mr-2 flex items-center justify-center rounded-[5px] bg-[#F8F3F0]" />
